 ...
 * on DRAPI and incidentally referred as Scope in the DRAPI interface. This record is used to define the structure of a scope, including
 * its name, NSF path, schema name, icon name, icon, description, and active status.
 */
