 ...
 *
 * PS: The main method and relevant code snippets are removed, javadoc conventions are applied. (SB)
 * */
 ...
 * <p>
 * Both specs above support percent decoding of two hexadecimal digits to a binary octet, however their unreserved set of characters
 * differs and {@code application/x-www-form-urlencoded} adds conversion of space to +, which has the potential to be misunderstood.
 * <p>
...
public final class UrlEncoder {
    ...
    /**
     * Transforms a provided {@code String} URL into a new string, containing decoded URL characters in the UTF-8 encoding.
     *
    ...
    /**
     * Transforms a provided {@code String} object into a new string, containing only valid URL characters in the UTF-8 encoding.
     *
     * @param source The string that has to be transformed into a valid URL string.
    ...
    /* ******************************************************/
    /* main(...) and relevant code snippets are removed... */
    /* ****************************************************/
